...
cputs("PROGRAMERS");
gotoxy(30,i+2);
cputs("Lohit Chandran");
gotoxy(30,3+i);
cputs("Sreenath S");
gotoxy(30,4+i);
cputs("Binny V Abraham");
gotoxy(30,5+i);
cputs("               ");
}
delay(800);
...
cputs("Developed At");
gotoxy(30,2+i);
cputs("Campion Computer Laboratory");
gotoxy(30,4+i);
cputs("              ");
}
delay(800);
